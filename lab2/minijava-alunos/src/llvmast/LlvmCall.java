...
public class LlvmCall extends LlvmInstruction {
	...
	public LlvmCall(LlvmRegister lhs, LlvmType type, LlvmPointer fnType,
	...
	public LlvmCall(LlvmRegister lhs, LlvmType type, String fnName,
			List<LlvmValue> args) {
		this.lhs = lhs;
		this.type = type;
		this.fnName = fnName;
	...
	public String toString() {
		...
		return "  " + lhs + " = " + "call " + type + " " + fnTypeResult + " "
				+ fnName + "(" + arguments + ")";
	}
}
